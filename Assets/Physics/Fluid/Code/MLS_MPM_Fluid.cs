...
public class MLS_MPM_Fluid : MonoBehaviour
{
    ...
    {
        //GraphicsBuffer buffer = new GraphicsBuffer(GraphicsBuffer.Target.Structured, ps.Length, )

        //visualize.SetGraphicsBuffer("ParticleBuffer", buffer);
        //visualize.SetInt("ParticleCount", particle);
